...
from kairos_tools import TOOL_REGISTRY, configure as configure_tools
...
def set_config(key, database):
    ...
    # Inject shared deps into kairos_tools module
...
# ══════════════════════════════════════════════════════════
# TOOL EXECUTION ENGINE (dispatches to kairos_tools.py)
# ══════════════════════════════════════════════════════════
...
async def execute_tool(tool_name, args):
    """Dispatch tool calls to registered handlers in kairos_tools.py."""
