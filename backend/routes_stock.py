...
async def create_item(data: dict):
    item = {
        ...
        "uom": data.get("uom", data.get("stock_uom", "KG")),
        "stock_uom": data.get("stock_uom", data.get("uom", "KG")),
        ...
        "hsn_sac": data.get("hsn_sac", data.get("hsn_code", "")),
        "hsn_code": data.get("hsn_code", data.get("hsn_sac", "")),
        ...
        "current_stock": data.get("current_stock", data.get("opening_stock", 0.0)),
